...
public class MySQLCallEventLogger extends AbstractServiceFieldEditorConfigPage {

	private String NAMESPACE = "ui.jface.configuration.pages.MySQLCallEventLogger";
    private String CONFIG_NAMESPACE = "service.MySQLCallEventLogger";
	...
	public String getNodeID() {
		return "MySQLCallEventLogger".toLowerCase();
	}
