...
public class MySqlJournal extends AbstractServiceFieldEditorConfigPage {

	private String NAMESPACE = "ui.jface.configuration.pages.MySqlJournal";
    private String CONFIG_NAMESPACE = "repository.MySqlJournal";
	...
	public String getNodeID() {
		return "MySqlJournal".toLowerCase();
	}
