...
public class IdentifiedOutgoingCall extends AbstractHandler implements IEventSender {
	...
	private class HandlerThread implements Runnable {
		...
		public void run() {
			if (getRuntime().getMsnManager().isMsnMonitored(
				...
				evb.send(this.m_s, evb.createEvent(IEventConst.EVENT_TYPE_IDENTIFIED_OUTGOING_CALL, this.m_c));
				m_logger.info("Send identified outgoing call event.");
	...
	public String getSenderID() {
		return "IdentifiedOutgoingCallHandler";
	}
