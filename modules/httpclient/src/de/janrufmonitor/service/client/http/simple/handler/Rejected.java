...
public class Rejected extends AbstractHandler implements IEventSender {
	...
	private class HandlerThread implements Runnable {
		...
		public void run() {
			...
			evb.send(this.m_s, evb.createEvent(IEventConst.EVENT_TYPE_CALLREJECTED, this.m_c));
			m_logger.info("Send call rejected event.");
