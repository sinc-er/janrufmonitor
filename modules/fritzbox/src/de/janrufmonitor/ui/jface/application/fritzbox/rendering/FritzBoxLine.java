...
public class FritzBoxLine extends AbstractTableCellRenderer implements IJournalCellRenderer {

	private static String NAMESPACE = "ui.jface.application.fritzbox.rendering.FritzBoxLine";
	...
	public String getID() {
		return "FritzBoxLine".toLowerCase();
	}
	
	private String getDuration(ICall call) {
		IAttribute ring = call.getAttribute("fritzbox.line");
