...
public class ZoomOutAction extends FontAction {

	private static String NAMESPACE = "ui.jface.application.action.ZoomOutAction";
	...
	public ZoomOutAction() {
		...
		this.setImageDescriptor(new ApplicationImageDescriptor(
			SWTImageManager.getInstance(this.getRuntime()).getImagePath(IJAMConst.IMAGE_KEY_ZOUT_GIF)
		));					
	}
