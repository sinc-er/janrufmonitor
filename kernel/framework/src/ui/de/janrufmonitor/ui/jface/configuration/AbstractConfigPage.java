...
public abstract class AbstractConfigPage extends PreferencePage implements IConfigPage {
	...
	protected Label createDescriptionLabel(Composite parent) {
		...
		description.setText(((desc!=null && !desc.equalsIgnoreCase("description")) ? desc : ""));
		return description;
	}
