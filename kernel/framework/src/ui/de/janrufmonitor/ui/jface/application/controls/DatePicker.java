...
public class DatePicker extends Composite {
	...
	//~ Constructors
	// -----------------------------------------------------------
	public DatePicker(Composite parent, int style, boolean fullDay) {
		super(parent, style);
	...
	public Date getDate() {
		// sebthom
		//return cal.getTime();
		// add 2007/04/09: corrected date picker control
		Calendar c = Calendar.getInstance();
		c.setTime(selectedDate);
		//c.set(Calendar.HOUR, 0);
		c.set(Calendar.HOUR_OF_DAY, (fullDay ? 23 : 0));
		c.set(Calendar.MINUTE,  (fullDay ? 59 : 0));
		c.set(Calendar.SECOND,  (fullDay ? 59 : 0));
